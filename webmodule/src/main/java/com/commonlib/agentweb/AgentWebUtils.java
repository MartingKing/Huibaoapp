...
import static com.commonlib.agentweb.AgentWebConfig.AGENTWEB_FILE_PATH;
import static com.commonlib.agentweb.AgentWebConfig.FILE_CACHE_PATH;
...
//            ignore.printStackTrace();
	...
	static boolean showFileChooserCompat(Activity activity,
		...
		try {
			Class<?> clz = Class.forName("com.commonlib.agentweb.filechooser.FileChooser");
