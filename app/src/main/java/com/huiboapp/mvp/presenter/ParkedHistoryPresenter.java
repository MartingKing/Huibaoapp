...
@ActivityScope
public class ParkedHistoryPresenter extends BasePresenter<ParkedHistoryContract.Model, ParkedHistoryContract.View> {
    @Inject
    ...
    @Inject
    public ParkedHistoryPresenter(ParkedHistoryContract.Model model, ParkedHistoryContract.View rootView) {
